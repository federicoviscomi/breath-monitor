...
public class ObexPutClient {
	...
	public static void main(final String[] args) throws IOException,
		...
		final ClientSession clientSession = (ClientSession) Connector
				.open(serverURL);
		final HeaderSet hsConnectReply = clientSession.connect(null);
		...
		final byte data[] = "Hello world!".getBytes("iso-8859-1");
