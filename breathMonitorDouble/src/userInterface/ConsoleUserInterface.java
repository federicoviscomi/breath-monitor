...
public class ConsoleUserInterface {
	...
	private static final class OperationRecord implements
			Comparable<OperationRecord> {
		...
		public OperationRecord(final String command, final Operation second,
				String commandString, String commandUsage) {
			this.first = command;
			this.second = second;
		...
		@Override
		public int compareTo(OperationRecord o) {
			return this.first.compareTo(o.first);
		}

	}

	static Thread breathMonitorThread = null;
	...
	public static void main(final String[] args) {
		try {
			java.util.Arrays.sort(ops);
			System.out
					.println("Breath Monitor\nby Federico Viscomi\ntype help for a command list\n");
	...
	public static void printUsage() {
		...
		format.append("\n");
		System.out.format(format.toString(), args.toArray());
	}
}
