...
public class BufferedScrollPlotter implements PlotterInterface {
	...
	public static void main(final String[] args) {
		final BufferedScrollPlotter p = new BufferedScrollPlotter(new JFrame(), 2 << 5);
	...
	public BufferedScrollPlotter(JFrame jFrame, int i) {
		this("Breath monitor", jFrame,i);
	}
